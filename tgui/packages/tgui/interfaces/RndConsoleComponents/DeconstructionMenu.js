...
import { Box, Button, Flex, Section, LabeledList, Section, Divider } from "../../components";
  ...
  return (
    <Flex.Item grow={1} basis="33%">
      <Section title="Gargantua">
        ...
        <p><b>Full Power</b>
          <Divider />
          <b>Charge</b>, you gain the ability to charge at a target. Destroying and knocking back, pretty much anything you collide with.</p>
        <Button
          content="Gargantua"
