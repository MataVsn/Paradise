/obj/effect/proc_holder/spell/click/mimic
	name = "Mimic"
...
/obj/effect/proc_holder/spell/click/mimic/cast(list/targets, mob/user)
...
/obj/effect/proc_holder/spell/click/mimic/proc/remember_form(atom/movable/A, mob/user)
...
/obj/effect/proc_holder/spell/click/mimic/proc/take_form(datum/mimic_form/form, mob/user)
	var/old_name = "[user]"
	if(ishuman(user))
...
/obj/effect/proc_holder/spell/click/mimic/proc/show_change_form_message(mob/user, old_name, new_name)
...
/obj/effect/proc_holder/spell/click/mimic/proc/restore_form(mob/user, show_message = TRUE)
	selected_form = null
	var/old_name = "[user]"
...
/obj/effect/proc_holder/spell/click/mimic/proc/show_restore_form_message(mob/user, old_name, new_name)
...
/obj/effect/proc_holder/spell/click/mimic/proc/examine_override(datum/source, mob/user, list/examine_list)
	examine_list.Cut()
...
/obj/effect/proc_holder/spell/click/mimic/proc/on_death(mob/user, gibbed)
	if(!gibbed)
		restore_form(user, FALSE)
		show_death_message(user)

/obj/effect/proc_holder/spell/click/mimic/proc/show_death_message(mob/user)
...
/obj/effect/proc_holder/spell/click/mimic/morph
...
/obj/effect/proc_holder/spell/click/mimic/morph/take_form(datum/mimic_form/form, mob/living/simple_animal/hostile/morph/user)
	..()
	user.assume()

/obj/effect/proc_holder/spell/click/mimic/morph/restore_form(mob/living/simple_animal/hostile/morph/user, show_message = TRUE)
	..()
	user.restore()

/obj/effect/proc_holder/spell/click/mimic/morph/show_change_form_message(mob/user, old_name, new_name)
...
/obj/effect/proc_holder/spell/click/mimic/morph/show_restore_form_message(mob/user, old_name, new_name)
...
/obj/effect/proc_holder/spell/click/mimic/morph/show_death_message(mob/user)
