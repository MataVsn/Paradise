...
/obj/effect/proc_holder/spell/glare/can_cast(mob/living/user = usr, charge_check = TRUE, show_message = FALSE)
...
/obj/effect/proc_holder/spell/enthrall/can_cast(mob/living/user = usr, charge_check = TRUE, show_message = FALSE)
...
/obj/effect/proc_holder/spell/collective_mind /can_cast(mob/living/user = usr, charge_check = TRUE, show_message = FALSE)
	if(user.incorporeal_move == INCORPOREAL_NORMAL)
		return FALSE
	. = ..()
...
/obj/effect/proc_holder/spell/blindness_smoke/can_cast(mob/living/user = usr, charge_check = TRUE, show_message = FALSE)
	if(user.incorporeal_move == INCORPOREAL_NORMAL)
		return FALSE
	. = ..()
...
/obj/effect/proc_holder/spell/reviveThrall/can_cast(mob/living/user = usr, charge_check = TRUE, show_message = FALSE)
	if(user.incorporeal_move == INCORPOREAL_NORMAL)
		return FALSE
	. = ..()
...
/obj/effect/proc_holder/spell/shadowling_extend_shuttle/cast_check(charge_check = TRUE, start_recharge = TRUE, mob/living/user)
	if(!shadowling_check(user))
		return FALSE
	if(extendlimit == 1)
...
/obj/effect/proc_holder/spell/smoke/shadowling_phase_shift/create_new_targeting()
	var/datum/spell_targeting/self/S = new()
	return S
